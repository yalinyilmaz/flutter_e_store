...
class CustomColor {
  ...
  static CustomColor greyColor = const CustomColor(
    shade50: Color(0xFFF2F2F2),
    shade100: Color(0xFFE6E6E6),
    shade200: Color(0xFFCCCCCC),
    shade300: Color(0xFFB3B3B3),
    shade400: Color(0xFF999999),
    shade500: Color(0xFF808080),
    shade600: Color(0xFF666666),
    shade700: Color(0xFF4D4D4D),
    shade800: Color(0xFF333333),
    shade900: Color(0xFF1A1A1A),
  );
}
