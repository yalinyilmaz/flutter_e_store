...
abstract class ProductClient {
  ...
  @POST("/products")
  Future<void> addProduct(@Body() ProductRequestModel requestModel);

  @POST("/categories")
  Future<void> addCategory(@Body() CategoryModel requestModel);

  @PUT("/categories/{id}")
  Future<void> editCategory(
      @Path("id") int id, @Body() CategoryModel requestModel);
  ...
  Future<void> editProduct(
      @Path("id") int id, @Body() ProductModel requestModel);
}
